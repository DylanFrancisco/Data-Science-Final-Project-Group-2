...
hhadata2015.seperated <- hhadata2015.seperated %>% 
  select("HHRG", "Therapies", "HHRG.Description", "Clinical_Severity_Level", "Functional_Severity_Level", "Service_Severity_Level", "Distinct.Beneficiaries", "Total.HHA.Medicare.Payment.Amount", "Average.HHA.Medicare.Payment.Amount") 
```
